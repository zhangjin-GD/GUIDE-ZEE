...
public class MeasurePoint extends Mbo implements MboRemote {

	public MeasurePoint(MboSet ms) throws RemoteException {
		super(ms);
	}
	...
	public void add() throws MXException, RemoteException {
		...
		if (parent != null) {
			...
			this.setValue("valueinit", 0, 11L);
			this.setValue("value", 0, 11L);
			this.setValue("valuelast", 0, 11L);
		}
	}
}
