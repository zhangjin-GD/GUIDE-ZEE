...
public class FldPOLineTaxCode extends FldCommonTaxCode {

	public FldPOLineTaxCode(MboValue mbv) throws MXException, RemoteException {
		super(mbv);
	}
	...
	public MboSetRemote getList() throws MXException, RemoteException {
		...
		if (owner != null) {
			...
			if ("AE03ADT".equalsIgnoreCase(company)) {
				...
				companiesSet.reset();
				if (appname.equalsIgnoreCase("UDPOMAT")) {
				...
				} else if (appname.equalsIgnoreCase("UDPOSER")) {
					if (!vendor.equalsIgnoreCase("") && vendor != null) {
						if (!companiesSet.isEmpty() && companiesSet.count() > 0) {
							String address2 = companiesSet.getMbo(0).getString("address2");
							if (!address2.equalsIgnoreCase("") && address2 != null) {
				...
				} else if (appname.equalsIgnoreCase("UDPOFIX")) {
					if (!vendor.equalsIgnoreCase("") && vendor != null) {
						if (!companiesSet.isEmpty() && companiesSet.count() > 0) {
							String address2 = companiesSet.getMbo(0).getString("address2");
							if (!address2.equalsIgnoreCase("") && address2 != null) {
	...
	public void action() throws MXException, RemoteException {
		...
		double predicttaxprice = mbo.getDouble("udpredicttaxprice");
