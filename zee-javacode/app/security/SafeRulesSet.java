...
public class SafeRulesSet extends HierarchicalMboSet implements HierarchicalMboSetRemote {

	private String table = "UDSAFERULES";
	private String keynum = "srnum";
	private String keyid = "udsaferulesid";

	public SafeRulesSet(MboServerInterface ms) throws RemoteException {
		super(ms);
	}

	@Override
	protected Mbo getMboInstance(MboSet ms) throws MXException, RemoteException {
		return new SafeRules(ms);
	}
