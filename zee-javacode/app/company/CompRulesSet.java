...
public class CompRulesSet extends HierarchicalMboSet implements HierarchicalMboSetRemote {

	private String table = "UDCOMPRULES";
	private String keynum = "comprulesnum";
	private String keyid = "udcomprulesid";

	public CompRulesSet(MboServerInterface ms) throws RemoteException {
		super(ms);
	}

	@Override
	protected Mbo getMboInstance(MboSet ms) throws MXException, RemoteException {
		return new CompRules(ms);
	}
